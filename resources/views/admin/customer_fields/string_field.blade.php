<div class="row mb-3">
    ...
    <div class="col-md-8">
        ...
        <div class="col-md-12">
            <input id="{{ $fieldName }}" type="text" class="form-control @error($fieldName) is-invalid @enderror"
                name="{{ $fieldName }}" value="{{ $fieldValue }}" 
                autocomplete="{{ $fieldName }}" autofocus>
            @error($fieldName)
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select id="{{ $fieldName }}_status" class="form-control form-select @error($fieldName."_status") is-invalid @enderror"
                        name="{{ $fieldName }}_status" required>
                        <option value="ACCEPTED" {{ $statusValue == "ACCEPTED" ? "selected" : "" }}>
                            ACCEPTED</option>
                        <option value="PROCESSING"
                            {{ $statusValue == "PROCESSING" ? "selected" : "" }}>
                            PROCESSING</option>
                        <option value="REJECTED" {{ $statusValue == "REJECTED" ? "selected" : "" }}>
                            REJECTED</option>
